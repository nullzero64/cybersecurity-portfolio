...
tshark -r capture.pcapng -Y "dns" -T fields -e dns.qry.name | grep ".bpakcaging.xyz" (see the data filtered via dns of the domain traffic with any "www" or so.. headers? of the website)
