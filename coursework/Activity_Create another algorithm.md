...
Displaying the string "allow_list.txt" and then displaying the list contained within remove_list.
...
```
      ...
      File "<ipython-input-5-b925af1022fc>", line 11
        with open(import_file, "r") as file:
                                            ^
...
Yes, there's a lot of IP Addresses from both files clearly printed.
...
```
      ...
      File "<ipython-input-25-5fea2b2011c3>", line 48
        print(ip_addresses)
        ^
...
it automates a list or display of IPs across both variables/files and even updating the file we wrote to to include the newly established combined data.
...
Helped me understand how algorithms, file reading and writing works alongside updating a file to a new one.
